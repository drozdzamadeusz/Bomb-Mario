...
Animation::Animation(sf::Texture* texture, sf::Vector2u imageCount, float switchTime, float currentImage)
:Animation::Animation(texture,imageCount,switchTime)
{
	this->_currentImage.x = currentImage;

}

void Animation::update(int row, float deltaTime, bool flipX, bool secondRow, bool defaultV)
{
